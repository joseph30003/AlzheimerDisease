...
public class DrugBank_metamap {

	public static void DataInput(String term,int source_id,String prefer_name, String Id,int score, Connection conn){
		try
		{
		PreparedStatement pst_user =  (PreparedStatement) conn.prepareStatement("INSERT INTO DrugBank_disease(indication,prefer_name,UMLS,score,id) VALUES(?,?,?,?,?)");
